    ...
    <defs>
      ...
      <mask id="lineMdCogOffFilled1">
        ...
        <g opacity="0">
          ...
          <use href="#lineMdCogOffFilled0" transform="rotate(60 12 12)" />
          <use href="#lineMdCogOffFilled0" transform="rotate(120 12 12)" />
          <use href="#lineMdCogOffFilled0" transform="rotate(180 12 12)" />
          <use href="#lineMdCogOffFilled0" transform="rotate(240 12 12)" />
          <use href="#lineMdCogOffFilled0" transform="rotate(300 12 12)" />
          <set
            attributeName="opacity"
            begin="0.4s"
            to="1"
